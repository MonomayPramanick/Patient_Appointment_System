   ...
   public void actionPerformed(ActionEvent e) {
    if (e.getSource() == b1) {
        ...
        try {
            ...
            String query = "INSERT INTO Doctor (name, doctor_id, username, city, email, gender, phone, age, password,specialization) "
                    + "VALUES ('" + name + "', '" + id + "', '" + username + "', '" + city + "', '" + email + "', '" + gender + "', '" + phone + "', '" + age + "', '" + password + "', '"+specialization+"')";
